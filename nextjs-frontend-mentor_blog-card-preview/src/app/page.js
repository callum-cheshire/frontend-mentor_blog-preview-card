...
export default function Home() {
  return (
    <main className='flex flex-col items-center justify-center min-h-screen align-middle p-2'>
      <div className='card bg-neutral-white text-neutral-black w-11/12 h-[450px] rounded-2xl border-solid border shadow-card overflow-hidden'>
        <div className='content p-5 h-full flex flex-col justify-between'>
          ...
          <div className='flex flex-col justify-end pt-4 pb-3 overflow-hidden'>
